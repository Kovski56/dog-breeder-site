  ...
  return (
    <main className="flex-1">
      ...
      <div className="mx-auto w-full max-w-3xl px-6 py-14">
        ...
        <div className="mb-10 rounded-2xl border border-brand/15 bg-white p-6 shadow-sm">
          <p className="mb-4 text-center text-lg font-bold text-brand sm:text-left">
            Forms &amp; Documents
          </p>
          <div className="space-y-4">
            <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:justify-between sm:text-left">
              <p className="text-foreground/80">
                Download a printable copy of our{" "}
                <span className="font-bold text-brand">Adoption Application &amp; Reservation Policy</span>.
              </p>
              <a
                href="/documents/adoption-application-and-reservation-policy.pdf"
                download
                target="_blank"
            ...
            <div className="flex flex-col items-center gap-3 border-t border-brand/10 pt-4 text-center sm:flex-row sm:justify-between sm:text-left">
              <p className="text-foreground/80">
                Please review our{" "}
